        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link p-0 pr-3" data-toggle="dropdown" href="#">
                    <img src="{{asset('dashboardAsset/img/avatar5.png')}}" class='img-circle elevation-2' width="40" height="40" alt="">
                </a>
...
<!-- ./wrapper -->
<!-- jQuery -->
<script src="{{asset('dashboardAsset/plugins/jquery/jquery.min.js')}}"></script>
<!-- Bootstrap 4 -->
<script src="{{asset('dashboardAsset/plugins/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
<!-- AdminLTE App -->
